  ...
  outputs = { self, nixpkgs, ... }:
    let
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [ "aarch64-linux" "x86_64-linux" "aarch64-darwin" "x86_64-darwin" ]
    ...
    in {
      ...
      # create a NixOS configuration for testing CTLSSA on a VM in Linux using `nixos-rebuild --flake .#linuxVM build-vm`
